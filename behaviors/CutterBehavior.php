...
namespace davfervaz\cutter\behaviors;
...
class CutterBehavior extends \yii\behaviors\AttributeBehavior
{
    ...
    public function upload($attribute)
    {
        if ($uploadImage = UploadedFile::getInstance($this->owner, $attribute)) {
            ...
            $croppingFile = $croppingFileBasePath . DIRECTORY_SEPARATOR . $croppingFileName . $croppingFileExt;
            ...
            $this->owner->{$attribute} = $this->baseDir . DIRECTORY_SEPARATOR . $croppingFileName . $croppingFileExt;
